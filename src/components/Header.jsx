...
const Header = () => {
  return (
    <header className="fixed top-0 w-full z-50 flex bg-primary text-secondary justify-between items-center p-7 md:flex-col md:gap-y-5">
      <h1 className="font-ShareTech text-5xl sm:text-4xl hover:cursor-pointer">
        Prima<span className="text-button">putra</span>
