...
const About = () => {
  return (
    <section
      id="about"
      className="jumbotron pt-5  bg-bg-primary text-secondary bg-wave-pattern bg-cover md:bg-none md:pt-32 animate-fadeIn"
        ...
        <div className="jumbotron-text w-[65%] md:w-full">
          <div className="jumbotron_header text-5xl sm:text-4xl">
            <h1 className="my-5 font-semibold sm:my-2">
              Hello Everyone<span className="text-button font-bold">!</span>
            </h1>
          ...
          <p className="text-lg my-5 sm:text-base">
            ...
            <a className="block text-2xl bg-button w-fit p-3 rounded-lg font-semibold md:mx-auto md:my-10 sm:text-xl hover:cursor-pointer hover:scale-110 ease-in duration-100">
              Let's Connect!
            </a>
        </div>
        <div className="jumbotron_image md:bg-blop-pattern md:bg-cover md:rounded-full md:mx-auto md:hidden">
          <img src={mySelfImage} alt="My Image" className="md:w-64" />
        </div>
      </div>
    </section>
  );
